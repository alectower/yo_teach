...
(function() {
  ...
  ToDo = (function() {
    var removeToDo, removeToDoFromPage;

    function ToDo() {}

    ToDo.remove = function() {
      return $('.to-do').change(function() {
        return removeToDo(this.id);
      });
    };
    ...
    removeToDo = function(id) {
      return $.ajax({
        ...
        url: '/to_dos/' + id,
        success: function() {
          return removeToDoFromPage(id);
        }
      });
    };

    removeToDoFromPage = function(id) {
      return setTimeout($('#' + id).parent().remove(), 5000);
    };
